...
![Предупреждение Rufus о записи ISOHybrid в режиме DD](rufus-isohybrid.png)
...
![Rufus завершил запись загрузочной флешки](rufus-finished.png)
...
![Рабочий стол Live-системы Manjaro](manjaro-live.jpeg)
...
![Выбор языка установщика Manjaro](installer-language.jpeg)
...
![Выбор региона и часового пояса](installer-location.jpeg)
...
![Выбор английской раскладки клавиатуры](installer-keyboard.jpeg)
...
![Выбор способа разметки диска](installer-partition-options.jpeg)
...
![Окно ручной разметки, которое в этом маршруте не используется](installer-manual-partition.jpeg)
...
![Варианты настройки swap в установщике](installer-swap-menu.jpeg)
...
![Выбран файл подкачки и файловая система ext4](installer-swap-file.jpeg)
...
![Готовые параметры очистки диска и файла подкачки](installer-disk-ready.jpeg)
...
![Создание пользователя и пароля](installer-user.jpeg)
...
![Выбор No Office Suite](installer-office.jpeg)
...
![Итоговая сводка перед установкой Manjaro](installer-summary.jpeg)
...
![Установка Manjaro завершена](installer-finished.jpeg)
...
![Первое обновление Manjaro завершено](first-system-update.jpeg)
...
![Проверка активного файла подкачки](swap-check.jpeg)
